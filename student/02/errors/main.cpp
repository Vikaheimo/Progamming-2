...
bool is_word_allready_guessed(string secret, string guessed);
...
int main() {
    ...
    while ( not is_word_allready_guessed(secret_word, guessed_letters)
    ...
    if ( not is_word_allready_guessed(secret_word, guessed_letters) ) {
        cout << endl
             << "Guesses expired!"
             << endl;
